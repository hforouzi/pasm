    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                <h4 class="panel-title">فهرست توابع و تعریف منو ها </h4>
            </div>

            <div class="panel-body">

                {!! Form::open(['route'=>'menu.get_data']) !!}
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label">
                            نام منو <span class="symbol required" aria-required="true"></span>
                        </label>
                        {!! Form::text('menu_name',null,array('placeholder' => "اسم منو را وارد نمایید",'class' => 'form-control'))!!}
                    </div>
                </div>
